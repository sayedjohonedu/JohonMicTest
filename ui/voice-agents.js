    ...
    card.innerHTML = `
      ...
      <div class="composer-body">
        <div class="composer-header">
          ...
          <button class="composer-hide" title="${isHidden ? 'Show block' : 'Hide block (skip in pipeline)'}" aria-label="${isHidden ? 'Show block' : 'Hide block (skip in pipeline)'}">
            ${isHidden
              ? '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/></svg>'
              : '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>'}
          </button>
          <button class="composer-remove" title="Remove block" aria-label="Remove block">
    ...
    card.innerHTML = `
      <div class="home-card-top">
        ...
        <div class="home-card-actions">
          ...
          ${agent.isBuiltIn ? '' : `<button class="home-delete-btn" title="Delete" aria-label="Delete">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
              <line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/>
            </svg>
          </button>`}
