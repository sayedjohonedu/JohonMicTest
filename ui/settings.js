...
window.addLangHotkeyRow = function(combo = '', lang = 'bn-BD') {
  ...
  row.innerHTML = `<div class="row-icon" style="background:rgba(108,99,255,0.08); font-size:14px;">🔑</div><div class="row-info" style="flex-direction:row; align-items:center; gap:8px;"><div class="key-badge val-combo" style="cursor:pointer;">${combo ? formatCombo(combo) : 'Not set'}</div><span style="font-size:12px; color:var(--muted)">triggers</span><div class="select-wrapper"></div></div><div class="key-controls"><button class="btn-action btn-del-row" style="color:#ff6b6b; border-color:rgba(255,107,107,0.3)">✕</button></div>`;
